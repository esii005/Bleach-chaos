...
def display_score():
   ...
   score_surf = test_font.render(f'point: {current_time}',False,(64,64,64))
...
start_time = 0
point = 0
bg_Music = pygame.mixer.Sound('Fweah.mp3')
...
sky_surface = pygame.image.load('space sky.png').convert()
ground_surface = pygame.image.load('ground.jpg')


# score_surf = test_font.render('survival game', False, 'Purple').convert()
# score_rect = score_surf.get_rect(center = (400,50))
...
game_name = test_font.render('Wizard runner', False, 'Purple')
game_name_rect = game_name.get_rect(center = (400,80))

game_message = test_font.render('press space to run',False,'Purple')
...
while True:
    ...
    if game_active:
        screen.blit(sky_surface,(0,-140))
        screen.blit(ground_surface,(0,300))
        # pygame.draw.rect(screen,'#0C090A', score_rect)
        # pygame.draw.rect(screen,'#0C090A', score_rect,10)
        # screen.blit(score_surf,score_rect)
        point = display_score()
       ...
       # screen.blit(snail_surface,snail_rect)
        ...
        point_message = test_font.render(f'your point: {point}',False,'Purple')
        point_message_rect = point_message.get_rect(center = (400,330))
        screen.blit(game_name, game_name_rect)

        if point == 0: screen.blit(game_message,game_message_rect)
        else: screen.blit(point_message,point_message_rect) 
